...
export function fallbackAnswer(category = 'DIAG') {
  if (category === 'FAP') {
    return [
      ...
      '',
      '## À faire maintenant',
      '- Évite les trajets très courts ; réduis la charge.',
      ...
      '',
      '## Prochaine étape',
      'Le **nettoyage FAP Re-FAP** est souvent la meilleure option si le FAP n’est pas endommagé (économique dès ~99€, éco-responsable, résultat ≈ neuf).',
      '',
...
// Gardé pour compatibilité, mais l’engine “no-OOD” ne l’appelle plus.
